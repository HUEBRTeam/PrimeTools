...
int main(int argc, char **argv)
{
	...
	crc = crc32(0L, Z_NULL, 0);
    	...
    	//  PrimeOS 0xFC Trailing
	printf("Size: %u\n", offset);
	unsigned char *PrimeMagic = (unsigned char *)&offset;
	unsigned char magic = (PrimeMagic[1] + PrimeMagic[2]) | 0x10;
	printf("PrimeOS Magic: %x\n", magic);
	rom_image[offset-1] = magic;
